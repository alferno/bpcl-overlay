export const ITEM_ID_NAME: Record<number, string> = {
  "1": "blink",
  "2": "blades_of_attack",
  "3": "broadsword",
  "4": "chainmail",
...
export const ITEM_NAME_TO_ID: Record<string, number> = Object.entries(ITEM_ID_NAME).reduce((acc, [id, name]) => {
  acc[name] = Number(id);
  acc[`item_${name}`] = Number(id);
  return acc;
