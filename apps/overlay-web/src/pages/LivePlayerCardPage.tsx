...
export function LivePlayerCard() {
  ...
  const scanRadPct = Math.max(
    0,
    Math.min(1, 1 - (m.radiantScanCooldown || 0) / 210),
  )
  const scanDirePct = Math.max(
    0,
    Math.min(1, 1 - (m.direScanCooldown || 0) / 210),
  )
  const glyphRadPct = Math.max(
    0,
    Math.min(1, 1 - (m.radiantGlyphCooldown || 0) / 300),
  )
  const glyphDirePct = Math.max(
    0,
    Math.min(1, 1 - (m.direGlyphCooldown || 0) / 300),
  )
  ...
  const isTestGame =
    ...
    window.location.pathname.includes('/test-game')
  ...
  return (
    ...
    >
      ...
      {minimapVisible && (
        ...
        >
          ...
          <div className='absolute inset-0 bg-[#061016] rounded-l-[20px] rounded-r-[42px] border border-[rgba(55,76,93,0.5)] shadow-[0_12px_40px_rgba(0,0,0,0.7)] overflow-hidden z-0'>
            ...
            >
              <path
                d='M80,0 Q40,42 80,84'
                fill='none'
                stroke='#374c5d'
                strokeWidth='2'
              />
              <path
                d='M160,0 Q120,42 160,84'
                fill='none'
                stroke='#374c5d'
                strokeWidth='2'
              />
              <path
                d='M240,0 Q200,42 240,84'
                fill='none'
                stroke='#374c5d'
                strokeWidth='2'
              />
              <path
                d='M320,0 Q280,42 320,84'
                fill='none'
                stroke='#374c5d'
                strokeWidth='2'
              />
          ...
          <div className='relative z-10 w-[54px] h-[54px] rounded-full border-[2px] border-[rgba(16,185,129,0.3)] bg-[#030a08] shadow-[0_8px_20px_rgba(0,0,0,0.8),inset_0_0_12px_rgba(16,185,129,0.1)] flex flex-shrink-0 items-center justify-center overflow-visible'>
            ...
            <div
              className={`w-full h-full rounded-full overflow-hidden shadow-[inset_0_0_15px_#000] relative flex items-center justify-center ${!roshanAlive ? 'opacity-60 grayscale' : ''}`}
            >
              <img
                src={withBaseUrl('/icons/Roshan_mapicon_dota2_gameasset.png')}
                alt='Roshan'
                className={`w-[130%] h-[130%] object-cover object-center translate-y-[5%] transition-all ${!roshanAlive ? 'opacity-40' : ''}`}
              />
              {!roshanAlive &&
                m.roshanRespawnTimer &&
                m.roshanRespawnTimer > 0 && (
          ...
          <div className='relative z-10 w-[54px] h-[54px] rounded-full border-[2px] border-[rgba(16,185,129,0.3)] bg-[#030a08] shadow-[0_8px_20px_rgba(0,0,0,0.8),inset_0_0_12px_rgba(16,185,129,0.1)] flex flex-shrink-0 items-center justify-center overflow-visible'>
            ...
            <div className='absolute -right-[5px] top-[50%] -translate-y-[50%] w-2.5 h-2.5 rotate-45 bg-[#10b981] border border-[#374151]' />
            <div
              className={`w-full h-full rounded-full overflow-hidden shadow-[inset_0_0_15px_#000] relative flex items-center justify-center ${tormDead ? 'opacity-60 grayscale' : ''}`}
            >
              <img
                src={withBaseUrl(
                  tormDireAlive
                    ? '/icons/Tormentor_(Dire)_icon_dota2_gameasset.png'
                    : '/icons/Tormentor_(Radiant)_icon_dota2_gameasset.png',
                )}
                alt='Tormentor'
          ...
          <div className='relative z-10 w-[54px] h-[54px] rounded-full border-[2px] border-[rgba(16,185,129,0.3)] bg-[#030a08] shadow-[0_8px_20px_rgba(0,0,0,0.8),inset_0_0_12px_rgba(16,185,129,0.1)] flex flex-shrink-0 items-center justify-center overflow-visible'>
            ...
            <div className='w-full h-full rounded-full overflow-hidden shadow-[inset_0_0_15px_#000] relative flex items-center justify-center'>
              <svg width='100%' height='100%' viewBox='0 0 80 80'>
                <defs>
                  <clipPath id='scan-rad-base'>
                    <rect x='0' y='0' width='40' height='80' />
                  </clipPath>
                  <clipPath id='scan-dire-base'>
                    <rect x='40' y='0' width='40' height='80' />
                  </clipPath>
                  <clipPath id='scan-rad-prog'>
                    <rect
                      x='0'
                      y={80 - 80 * scanRadPct}
                      width='40'
                      height={80 * scanRadPct}
                    />
                  </clipPath>
                  <clipPath id='scan-dire-prog'>
                    <rect
                      x='40'
                      y={80 - 80 * scanDirePct}
                      width='40'
                      height={80 * scanDirePct}
                    />
                  </clipPath>
                </defs>
          ...
          <div className='relative z-10 w-[54px] h-[54px] rounded-full border-[2px] border-[rgba(16,185,129,0.3)] bg-[#030a08] shadow-[0_8px_20px_rgba(0,0,0,0.8),inset_0_0_12px_rgba(16,185,129,0.1)] flex flex-shrink-0 items-center justify-center overflow-visible'>
            ...
            <div className='w-full h-full rounded-full overflow-hidden shadow-[inset_0_0_15px_#000] relative flex items-center justify-center'>
              <svg width='100%' height='100%' viewBox='0 0 80 80'>
                <defs>
                  <clipPath id='glyph-rad-base'>
                    <rect x='0' y='0' width='40' height='80' />
                  </clipPath>
                  <clipPath id='glyph-dire-base'>
                    <rect x='40' y='0' width='40' height='80' />
                  </clipPath>
                  <clipPath id='glyph-rad-prog'>
                    <rect
                      x='0'
                      y={80 - 80 * glyphRadPct}
                      width='40'
                      height={80 * glyphRadPct}
                    />
                  </clipPath>
                  <clipPath id='glyph-dire-prog'>
                    <rect
                      x='40'
                      y={80 - 80 * glyphDirePct}
                      width='40'
                      height={80 * glyphDirePct}
                    />
                  </clipPath>
                </defs>
                ...
                <g opacity='0.25'>
                  <g clipPath='url(#glyph-rad-base)'>
                    <path
                      d='M28,60 L52,60 L48,35 L54,35 L54,20 L48,20 L48,26 L43,26 L43,20 L37,20 L37,26 L32,26 L32,20 L26,20 L26,35 L32,35 Z'
                      fill='#22c55e'
                    />
                  </g>
      ...
      {livePlayerVisible && (
        <div
          className='absolute left-[264px] top-[670px] z-20 pointer-events-none origin-bottom-left transition-all duration-300'
          style={{
