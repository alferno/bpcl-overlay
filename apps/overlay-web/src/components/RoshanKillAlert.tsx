...
export function RoshanKillAlert() {
  ...
  const isStolen = Boolean(event && event.killerTeam && event.pickerTeam && event.killerTeam !== event.pickerTeam);

  const theme = isStolen
    ? {
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div
                    style={{
                      ...
                      textTransform: "uppercase",
                      color: isStolen ? theme.primary : "rgba(148,163,184,0.6)",
                      lineHeight: 1,
                    }}
                  >
                    {isStolen ? "AEGIS STOLEN" : "Picked by"}
                  </div>
                  <div
                    style={{
                      fontFamily: "'Bebas Neue', 'Arial Narrow', sans-serif",
                  ...
                  >
                    {isStolen && event.pickerPlayerName ? event.pickerPlayerName : event.teamName}
                  </div>
                </div>
