...
const newComponent = `export default function StandoutPlayerPage() {
            ...
            >
              ...
              <div className="flex w-full max-w-[1300px] justify-between gap-16">
                ...
                >
                  ...
                  >
                    <img
                      src={(!cardError && card.steam32) ? withBaseUrl(\`/cards/\${card.steam32}.png\`) : portraitUrl}
                      alt="Player/Hero"
...
const idx = content.indexOf("export default function StandoutPlayerPage() {");
if (idx !== -1) {
  content = content.substring(0, idx) + newComponent + "\n";
